...
def main():
    ...
    # ex 9.1.1
    # print(are_files_equal(r"C:\Users\user\Desktop\sigitDana\name_length.txt",
    #                       r"C:\Users\user\Desktop\sigitDana\randomWords.txt"))

    # ex 9.1.2
    # main_program()

    # ex 9.2.2
    # copy_file_content(r"C:\Users\user\Desktop\sigitDana\name_length.txt",
    #                        r"C:\Users\user\Desktop\sigitDana\randomWords.txt")

    # ex 9.2.3
    # print(who_is_missing(r"C:\Users\user\Desktop\sigitDana\findMe.txt"))

    # ex 9.3.1
    # print(my_mp3_playlist(r"C:\Users\user\Desktop\sigitDana\songs.txt"))

    # ex 9.3.2
    # print(my_mp4_playlist(r"C:\Users\user\Desktop\sigitDana\songs.txt", "Python Love Story"))
